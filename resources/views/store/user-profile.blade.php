        ...
        <div class="tab-pane fade" id="reset-password">
            ...
            <form action="{{route('password.update')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="current_password" id="current-password" class="form-control" value="{{$user->email}}" required>
                </div>

                <div class="form-group">
                    <label for="new-password">New Password</label>
                    <input type="password" name="password" id="new-password" class="form-control" value="{{$user->phone}}" required>
                </div>
